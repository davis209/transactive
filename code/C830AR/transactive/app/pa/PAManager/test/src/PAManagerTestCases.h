/**
  ...
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/pa/PAManager/test/src/PAManagerTestCases.h $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
class PaManagerTestCases : public TestCase
{

public:
	PaManagerTestCases ( const std::string & name ) : TestCase ( name )
	{
	}

	virtual ~PaManagerTestCases()
	{
	}
