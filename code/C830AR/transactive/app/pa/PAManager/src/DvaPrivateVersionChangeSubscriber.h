 ...
 * in any form.
 *
 * Source: $File: //depot/C830AR_TIP/C830AR/transactive/app/pa/PAManager/src/DvaPrivateVersionChangeSubscriber.h $
 * @author Jade Lee
 * @version $Revision: #3 $
...
protected:
    ...
    virtual TA_Base_Bus::IPAAgentCorbaDef::DvaPrivateVersionRecords getNotificationData(
        const TA_Base_Bus::IPAAgentCorbaDef::DvaPrivateVersionRecords& packetData)
    {
        return packetData;
    }
