/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/maintenance_management/mms_agent/test/module/src/MmsJobRequestSubmitterTest.h $
  * @author:  C. DeWolfe
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This class provides the module tests for the MmsJobRequestSubmitter class
  */

#if !defined(MmsJobRequestSubmitterTest_H)
#define MmsJobRequestSubmitterTest_H
...
class MmsJobRequestSubmitterTest : public TestCase  
{

protected:

	//see implimentation for comments:
	void submitJobRequestFromAlarmTest();
	void submitJobRequestFromSchematicTest();
...
public:
	...
	MmsJobRequestSubmitterTest ( const std::string & name ) : TestCase ( name )
	{
	}

	virtual ~MmsJobRequestSubmitterTest()
	{
	}
...
#endif // !defined(MmsJobRequestSubmitterTest_H)
