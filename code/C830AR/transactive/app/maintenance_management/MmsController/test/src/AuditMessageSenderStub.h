/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/maintenance_management/MmsController/test/src/AuditMessageSenderStub.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        static bool verifyLastAuditMessage(const MessageType& type_info);
        /// Clears internal buffer of audit messages 
        /// (verifyLastAuditMessage will then return false)
        static void clearAuditMessages();
        
        // Add dummy default parameter to this method, otherwise get linker errors
    ...
    private:
        ...
        static const MessageType* s_lastAuditMessageType;
    };
}